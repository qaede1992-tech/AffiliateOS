...
export function AutonomousObservabilityPanel() {
  ...
  if (loading) {
    return <section className="analytics-section" id="autonomous-observability"><div className="section-heading"><div><p className="eyebrow">Decision trace</p><h2>Autonomous selection</h2></div></div><p className="empty">Loading decision audits...</p></section>;
  }
