...
test("anomaly recovery requires stable post-halt performance evidence",async()=>{
 ...
 const followUp={...halt,id:"f",recoveryEpisodeId:"h",recoveryState:"recovering",clickCount:120,conversionCount:16,conversionRate:16/120,anomaly:"none",anomalyScore:0,recoveryEvidenceScore:0.8,observedAt:"2026-01-01T12:00:00.000Z"};
 const followUp2={...followUp,id:"f2",recoveryEpisodeId:"h",clickCount:130,conversionCount:18,conversionRate:18/130,observedAt:"2026-01-01T18:00:00.000Z"};
 const followUp3={...followUp,id:"f3",recoveryEpisodeId:"h",clickCount:135,conversionCount:20,conversionRate:20/135,observedAt:"2026-01-01T23:00:00.000Z"};
...
test("recovered state has hysteresis against a single post-recovery watch signal",async()=>{
 ...
 const recovered={...halt,id:"r",recoveryEpisodeId:"h",recoveryState:"recovered",clickCount:140,conversionCount:25,anomaly:"none",anomalyScore:0,recoveryState:"recovered",recoveryEvidenceScore:.9,observedAt:"2026-01-02T00:00:00.000Z"};
...
test("recovery signals retain a stable episode identity",async()=>{
 ...
 const followUp2={...followUp,id:"f2",recoveryEpisodeId:"episode-halt-1",clickCount:130,conversionCount:18,conversionRate:18/130,observedAt:"2026-01-01T18:00:00.000Z"};
 const followUp3={...followUp,id:"f3",recoveryEpisodeId:"episode-halt-1",clickCount:135,conversionCount:20,conversionRate:20/135,observedAt:"2026-01-01T23:00:00.000Z"};
 const memory:any={latestByProductAndMarketplace:async()=>halt,recentByProductAndMarketplace:async()=>[halt,followUp,followUp2,followUp3],saveIfAbsent:async(s:any)=>s};
 const provider=new AutonomousAnalyticsFeedbackProvider(analytics,memory,()=>now);
 const signal=(await provider.getSignals()).get("m:p");
 assert.equal(signal?.anomalyRecovery,"recovered");
