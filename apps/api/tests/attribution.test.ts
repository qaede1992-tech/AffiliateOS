...
test("conversion attribution is explicit and one-to-one", async () => {
  ...
  await links.save({ id: otherLinkId, affiliateOfferId: "00000000-0000-0000-0000-000000000304", code: "attr4", destinationUrl: "https://example.com/other", status: "active", createdAt: now, updatedAt: now });
