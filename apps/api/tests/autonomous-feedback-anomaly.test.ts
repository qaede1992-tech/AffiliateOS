...
const campaign:any={campaignId:"c",productId:"p",marketplaceId:"m",clickCount:200,trackingLinkCount:1,contentCount:1,publishedContentCount:1,scheduledContentCount:0,attributedConversionCount:20,attributedRevenueCents:10000,attributedCommissionCents:1000,conversionRate:.2};
...
test("large multi-window conversion shift is halted",async()=>{
 const memory:any={...base,recentByProductAndMarketplace:async()=>[
  {clickCount:0,conversionCount:0,observedAt:"2026-08-25T00:00:00Z"},
  {clickCount:100,conversionCount:1,observedAt:"2026-09-22T00:00:00Z"}
 ]};
