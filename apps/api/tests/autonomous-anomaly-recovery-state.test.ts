...
test("recovering anomaly heavily damps performance influence",()=>{
 const product:any={id:"p",marketplaceId:"m",status:"active",name:"P",priceCents:1000,currency:"USD",productUrl:"https://example.test/p",category:"x"};
 const offer:any={id:"o",productId:"p",status:"active",commissionRateBps:1000,commissionAmountCents:100};
