...
CREATE INDEX IF NOT EXISTS publication_operations_content_idx
  ON publication_operations (content_id);

CREATE INDEX IF NOT EXISTS publication_operations_status_idx
  ON publication_operations (status);
