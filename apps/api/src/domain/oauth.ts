...
export interface OAuthStateRepository { save(state: OAuthState): Promise<OAuthState>; consume(state: string, platform: string): Promise<OAuthState | undefined>; }
