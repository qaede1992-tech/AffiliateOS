...
type ExplorationGroupSignal = Pick<AutonomousExplorationState, "sampleCount" | "promotedCount" | "deprioritizedCount" | "optimizationPositiveCount" | "optimizationNegativeCount">;
