...
export interface MarketplaceProductInput { externalProductId: string; name: string; description?: string; category?: string; priceCents: number; originalPriceCents?: number; currency: string; ratingMilli?: number; reviewCount?: number; soldCount?: number; imageUrl?: string; videoUrl?: string; productUrl: string; availability: ProductAvailability; affiliateLinkExpiresAt?: IsoTimestamp; metadata?: Record<string, unknown>; }
